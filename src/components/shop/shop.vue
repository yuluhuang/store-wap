...
<script>
    ...
    import {shopDetails, foodMenu, getRatingList, ratingScores, ratingTags} from '../../mock/getData'
...
//                    this.RECORD_ADDRESS(res)
                ...
                // 获取商铺信息
                this.shopDetailData = shopDetails
                // 获取商铺食品列表
                this.menuList = foodMenu
                // 评论列表
                this.ratingList = getRatingList
                // 商铺评论详情
                this.ratingScoresData = ratingScores
                // 评论Tag列表
                this.ratingTagsList = ratingTags
